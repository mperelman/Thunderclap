...
- Use the BODY TEXT naming conventions as the source of truth for spellings and titles.
- Ignore endnote variants if they conflict with the body text (including Jr./Sr. vs I/II and spelling standardization).
...
- CRITICAL: GENEALOGY AND LINEAGE — NO INVENTED FAMILY TREES:
  ...
  * CRITICAL — COREFERENCE RESOLUTION: When a passage uses a pronoun or demonstrative ("this family," "the family," "this bank," "the firm," "they," "he," "she"), resolve it to the NEAREST named entity of the same type stated EARLIER in the same passage — NOT to the query subject and NOT to any entity mentioned LATER in the passage. Example: a passage reads "Key to this trade was the Hoffmann family. This family descended from [ancestor]... [Hoffmann details]... Wertheim Bank expanded..." — the ancestry claim belongs to the HOFFMANN FAMILY. Wertheim Bank appearing later in the same passage does NOT inherit the Hoffmann ancestry, even if the query is about Wertheim Bank. NEVER attribute a genealogical claim to an entity that appears AFTER the claim in the passage.
...
- Spelling rule for endnotes: If body text uses a specific spelling (e.g., Wulff), you MUST use that spelling and ignore endnote variants (e.g., Wolf).
