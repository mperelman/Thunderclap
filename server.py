    ...
    try:
        ...
        if os.path.exists(INDICES_FILE):
            ...
            common_words = {
                ...
                # Common first names (exclude from hyperlinking)
                'joseph', 'john', 'william', 'james', 'robert', 'thomas', 'david', 'richard', 'charles', 'daniel', 'matthew', 'anthony', 'mark', 'donald', 'paul', 'steven', 'andrew', 'kenneth', 'joshua', 'kevin', 'brian', 'george', 'edward', 'ronald', 'timothy', 'jason', 'jeffrey', 'ryan', 'jacob', 'gary', 'nicholas', 'eric', 'stephen', 'jonathan', 'larry', 'justin', 'scott', 'brandon', 'benjamin', 'samuel', 'frank', 'gregory', 'raymond', 'alexander', 'patrick', 'jack', 'dennis', 'jerry', 'tyler', 'aaron', 'jose', 'henry', 'adam', 'douglas', 'nathan', 'zachary', 'kyle', 'noah', 'ethan', 'jeremy', 'walter', 'christian', 'terry', 'sean', 'lawrence', 'jason', 'juan', 'mason', 'roy', 'ralph', 'roger', 'eugene', 'wayne', 'arthur', 'louis', 'peter', 'harold', 'carl', 'alan', 'harry', 'randy', 'albert', 'arthur', 'joe', 'billy', 'jimmy', 'bobby', 'mike', 'tom', 'dan', 'steve', 'chris', 'matt', 'josh', 'nick', 'alex', 'sam', 'ben', 'jack', 'max', 'luke', 'noah', 'jake', 'ryan', 'tyler', 'zach', 'ethan', 'mason', 'logan', 'owen', 'connor', 'aidan', 'carter', 'julian', 'wyatt', 'grayson', 'leo', 'jayden', 'lincoln', 'hunter', 'eli', 'aaron', 'charlie', 'thomas', 'christopher', 'daniel', 'matthew', 'anthony', 'mark', 'donald', 'paul', 'steven', 'andrew', 'kenneth', 'joshua', 'kevin', 'brian', 'george', 'edward', 'ronald', 'timothy', 'jason', 'jeffrey', 'ryan', 'jacob', 'gary', 'nicholas', 'eric', 'stephen', 'jonathan', 'larry', 'justin', 'scott', 'brandon', 'benjamin', 'samuel', 'frank', 'gregory', 'raymond', 'alexander', 'patrick', 'jack', 'dennis', 'jerry', 'tyler', 'aaron', 'jose', 'henry', 'adam', 'douglas', 'nathan', 'zachary', 'kyle', 'noah', 'ethan', 'jeremy', 'walter', 'christian', 'terry', 'sean', 'lawrence', 'juan', 'mason', 'roy', 'ralph', 'roger', 'eugene', 'wayne', 'arthur', 'louis', 'peter', 'harold', 'carl', 'alan', 'harry', 'randy', 'albert',
                # Common verbs
                ...
                # Family/relationship words (exclude from hyperlinking)
                'family', 'families', 'cousin', 'cousins', 'son', 'sons', 'daughter', 'daughters', 'father', 'fathers', 'mother', 'mothers', 'brother', 'brothers', 'sister', 'sisters', 'uncle', 'uncles', 'aunt', 'aunts', 'nephew', 'nephews', 'niece', 'nieces', 'grandfather', 'grandmother', 'grandson', 'granddaughter', 'husband', 'husbands', 'wife', 'wives', 'spouse', 'spouses', 'widow', 'widows', 'widower', 'widowers',
                # Generic banking/finance words (exclude standalone)
                'bank', 'banks', 'banking', 'credit', 'credits', 'loan', 'loans', 'trust', 'trusts', 'employee', 'employees', 'worker', 'workers', 'staff', 'member', 'members',
